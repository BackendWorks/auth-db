...
[![Release](https://github.com/BackendWorks/auth-db/actions/workflows/release.yml/badge.svg)](https://github.com/BackendWorks/auth-db/actions/workflows/release.yml)
[![npm](https://img.shields.io/badge/npm-GitHub%20Packages-blue)](https://github.com/BackendWorks/auth-db/packages)
...
npm install @backendworks/auth-db
```
